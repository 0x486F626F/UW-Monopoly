CXX = g++
CXXFLAGS = -Wall -Wextra -MMD -Iinclude -Iinclude/events -Iinclude/display -Iinclude/strategy -lX11 -I/usr/X11/include -L/usr/X11/lib -g
EXEC = bb7k
...
DISPLAY = src/display/textdisplay.o src/display/window.o
