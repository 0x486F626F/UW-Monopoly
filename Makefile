CXX = g++ -Wall -Wextra -Iinclude -Iinclude/events -Iinclude/display -Iinclude/strategy -g -DX
EXEC = bb7k
...
${EXEC}: ${OBJECTS} ${EVENTS} ${DISPLAY} ${STRATEGY}
	${CXX} ${OBJECTS} ${EVENTS} ${DISPLAY} ${STRATEGY} -o ${EXEC}  -lX11 -I/usr/X11/include -L/usr/X11/lib
